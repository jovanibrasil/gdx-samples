...
public class Box2DSample extends SampleBase {

    public static final SampleInfo SAMPLE_INFO = new SampleInfo(Box2DSample.class);

    private static final Logger log = new Logger(Box2DSample.class.getName(), Logger.DEBUG);
    ...
    public void create() {
        ...
        // existe uma representação física para cada elemento gráfico
        // por exemplo, o objeto Body. Um objeto BodyDef define propriedades de um objeto body
        // o elemento gráfico precisa ser atualizado de acordo com o objeto físico

        batch = new SpriteBatch(); // usado para desenhar sprite
    ...
    @Override
    public void render() {
        // delta é a quantidade de tempo passado desde o último desde o últipo update
